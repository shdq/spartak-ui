    ...
    <div style={headerStyles}>
      ...
      >
        <g preserveAspectRatio="xMidYMid meet">
          ...
          <g>
            <g fill={logoColor} id="youtube-paths">
...
const menuItems = [
  { title: "Home", icon: <IconHome size={18} /> },
  { title: "Subscriptions", icon: <IconStack2 size={18} /> },
  { title: "Library", icon: <IconBrandYoutube size={18} /> },
  { title: "History", icon: <IconHistory size={18} /> },
  { title: "Your videos", icon: <IconPlayerPlay size={18} /> },
  { title: "Watch later", icon: <IconClock size={18} /> },
...
const SideMenu = ({ color, size }: SideMenuProps): JSX.Element => {
  ...
  const justLeft: React.CSSProperties = {
    justifyContent: "left",
  };

  const buttons = menuItems.map(({ title, icon }) => {
    const variant = title === active ? "tinted" : "text";
    return (
      <Button
        as="a"
        href="#"
